...
function callHost(method, params = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const onMessage = (event) => {
            ...
            if (response.channel !== FRAME_RESPONSE_CHANNEL
...
const sourceLanguage = requiredElement("source-language");
const targetLanguage = requiredElement("target-language");
const sourceText = requiredElement("source-text");
const translatedText = requiredElement("translated-text");
const sourceCount = requiredElement("source-count");
const resultCount = requiredElement("result-count");
const translateButton = requiredElement("translate");
const cancelButton = requiredElement("cancel");
const copyButton = requiredElement("copy");
...
async function copyResult() {
    ...
    try {
        if (window.parent !== window) {
            await callHost("clipboard.writeText", { value });
        }
